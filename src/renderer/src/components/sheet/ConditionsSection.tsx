...
import { BUFFS_5E, BUFFS_PF2E } from '../../data/conditions'
...
export default function ConditionsSection({ character, readonly }: ConditionsSectionProps): JSX.Element {
  ...
  const allConditions = getConditionsForSystem(system)
  const allBuffs = system === 'dnd5e' ? BUFFS_5E : BUFFS_PF2E
  ...
  return (
    <SheetSectionWrapper title="Conditions" defaultOpen={activeConditions.length > 0}>
